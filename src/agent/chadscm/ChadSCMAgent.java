 ...
 * Manufacturer agent using <code>{@link se.sics.tasim.tac03.aw.SCMAgent}</code> to simplify
 ...
 * </ul>
 */
public class ChadSCMAgent extends se.sics.tasim.tac03.aw.SCMAgent {

    private static final Logger log =
            Logger.getLogger(ChadSCMAgent.class.getName());
